...
class ProductoBaseController extends BaseController
{
    ...
    public function show(String $id){
        ...
        if(!$producto){
            return response()->json(['message' => "No se encontro el producto solicitado con ($id)"]);
        }
        return response()->json([
            'message' => "Producto encontado con id ($id)",
            'data' => $producto]);
    }
    ...
    public function destroy(String $id){
        ...
        if(!$producto){
            return response()->json(['message' => "No se pudo eliminar el producto con ($id)"]);
        }
